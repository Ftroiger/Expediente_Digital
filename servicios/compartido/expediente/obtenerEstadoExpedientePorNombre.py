...
async def obtenerEstadoExpedienteCreado(db) -> EstadoExpediente:
    try:
        ...
        tipoExpedienteList = await realizarConexionBD("obtenerTipoExpedientePorNombre", params, db, model=EstadoExpediente, keep=True)
